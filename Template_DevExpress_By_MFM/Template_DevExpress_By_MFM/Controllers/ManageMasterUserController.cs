...
namespace Template_DevExpress_By_MFM.Controllers
{
    public class ManageMasterUserController : ApiController
    {
        ...
        public ManageMasterUserController()
        {
            ...
            GSDbContextDev = new GSDbContext(@"", "", "", "");
        }
        ...
        [SessionCheck]
        [HttpGet]
        public HttpResponseMessage Get(DataSourceLoadOptions loadOptions, string email)
        {
            try
            {
                var dataList = GSDbContext.MasterUser.Where(p => p.email == email).ToList();
